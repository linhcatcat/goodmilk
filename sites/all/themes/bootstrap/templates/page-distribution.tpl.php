	...
	<div class="container menu">
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<?php
					$distribution = node_load(array(
						'type' => 'distribution',
					));
				?>
				<div class="content1">
					<div class="sub-title">
						<h1 class="title"><?php print $distribution->title; ?></h1>
					</div>
					<div class="sub_content">
						<div class="span12">
							<?php print $distribution->field_distribution_content[0]['value']; ?>
						</div>
