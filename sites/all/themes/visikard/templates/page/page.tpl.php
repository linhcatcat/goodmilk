...
<script type="text/javascript">stLight.options({publisher: "c394f16e-6c1a-45cf-868b-c096a6b21bcc", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
</head>
<body class="<?php print $classes . $cl; ?>">
	<?php if($admin_menu): ?>
...
<span class='st_youtube' displayText='Youtube Subscribe'></span>
      <?php if ($logo): ?>
...
$(document).ready(function() {
	$( 'ul > li.row-item' ).each(function(index, value){
		var id = $(this).attr('data');
		var heightMax = 200;
		$( '#'+id+' li div.item' ).each(function(index, value){
			if($(this).height() > heightMax){
				heightMax = $(this).height();
			}
		});
		$( '#'+id+' li div.item' ).height(heightMax);
	});
});
</script>
